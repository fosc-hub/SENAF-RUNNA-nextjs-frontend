...
import { getLocalizacions, createLocalizacion } from '../../api/TableFunctions/localizacion'
...
export default function LocalizacionPage() {
  ...
  const fetchLocalizacions = async () => {
    try {
      const fetchedLocalizacions = await getLocalizacions()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('Submitting transformed data:', newLocalizacion)

    try {
      await createLocalizacion(newLocalizacion)
      fetchLocalizacions()
      resetForm()
    } catch (error) {
